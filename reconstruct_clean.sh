...
# Remove art@0
sed -n '37,598p' ElectricVLSI/Libraries/Lab3.jelib | grep -v "Facet-Center" >> ElectricVLSI/Libraries/FourBitAdder_CMOS.jelib
# NAND Icon from FullAdder_CMOS
# Keep art@0 for icons as they usually need them
...
# Remove art@0
sed -n '31,91p' ElectricVLSI/Libraries/FullAdder_CMOS.jelib | grep -v "Facet-Center" >> ElectricVLSI/Libraries/FourBitAdder_CMOS.jelib
# FullAdder Schematic from FullAdder_CMOS
# Remove art@0
sed -n '92,193p' ElectricVLSI/Libraries/FullAdder_CMOS.jelib | grep -v "^X" | grep -v "Facet-Center" >> ElectricVLSI/Libraries/FourBitAdder_CMOS.jelib
